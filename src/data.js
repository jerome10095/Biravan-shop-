...
export const PRODUCTS = [
  { id: 1, name: "Tailored Wool Blazer", category: "Clothing", price: 145000, tag: "Trending", stock: 12,
    description: "Structured in a refined wool blend, this blazer combines sharp tailoring with a relaxed silhouette. A two-button closure, clean notch lapel, and a lightly padded shoulder create a frame that works from business meetings to elevated evenings.",
    images: [
  ...
  { id: 2, name: "Slim-Fit Oxford Shirt", category: "Clothing", price: 38000, tag: "New", stock: 25,
    description: "A wardrobe essential woven in crisp Oxford cloth. The slim cut drapes cleanly through the chest and shoulders, while the classic button-down collar keeps the look polished whether worn tucked or loose.",
    images: [
  ...
  { id: 3, name: "Classic Denim Jacket", category: "Clothing", price: 52000, tag: "Trending", stock: 18,
    description: "Washed to a lived-in perfection, this denim jacket brings effortless structure to any layered look. Chest pockets, a tailored cut, and a clean finish elevate it well above the ordinary.",
    images: [
  ...
  { id: 4, name: "Linen Resort Shirt", category: "Clothing", price: 34000, tag: null, stock: 20,
    description: "Spun from lightweight linen that breathes through warm weather with ease. The relaxed camp collar and subtle natural texture make it the natural choice for summer dressing, on or off the coast.",
    images: [
  ...
  { id: 5, name: "Wool Flannel Trousers", category: "Clothing", price: 46000, tag: null, stock: 15,
    description: "Cut from a mid-weight wool flannel that drapes with ease from waistband to break. A slightly tapered leg keeps the silhouette modern without sacrificing the comfort of a fuller cut.",
    images: [
  ...
  { id: 6, name: "Chukka Leather Boots", category: "Shoes", price: 95000, tag: "Trending", stock: 10,
    description: "Handcrafted from full-grain leather with a cushioned crepe-effect sole for quiet, refined wear. The ankle-height silhouette transitions effortlessly from formal to casual settings.",
    images: [
  ...
  { id: 7, name: "Classic Derby Shoes", category: "Shoes", price: 88000, tag: null, stock: 14,
    description: "A foundational piece in any considered wardrobe. Cut from smooth leather with open lacing and a leather sole, they reward years of wear with a deep, character-rich patina.",
    images: [
  ...
  { id: 8, name: "Canvas Low-Top Sneakers", category: "Shoes", price: 42000, tag: "New", stock: 30,
    description: "Built on a clean vulcanised sole with a sturdy canvas upper. Minimal by design and comfortable by nature — the versatile everyday choice that pairs with almost anything.",
    images: [
  ...
  { id: 9, name: "Full-Grain Leather Belt", category: "Accessories", price: 22000, tag: null, stock: 40,
    description: "Cut from a single strip of full-grain leather and finished with a solid-brass buckle. The width and weight are calibrated to work equally well with dress trousers and denim.",
    images: [
  ...
  { id: 10, name: "Aviator Sunglasses", category: "Accessories", price: 28000, tag: "Trending", stock: 22,
    description: "Precision-formed wire frames with teardrop lenses and full UV protection. A timeless shape that flatters a broad range of face structures and never looks out of place.",
    images: [
  ...
  { id: 11, name: "Automatic Chrono Watch", category: "Accessories", price: 135000, tag: "New", stock: 6,
    description: "A Swiss-inspired automatic movement visible through an exhibition caseback. Three sub-dials track elapsed hours, minutes, and seconds — a mechanical statement worn on the wrist.",
    images: [
  ...
  { id: 12, name: "Merino Wool Beanie", category: "Accessories", price: 15000, tag: null, stock: 35,
    description: "Knitted from extra-fine merino fibre for warmth without weight or itch. A rib-knit cuff and close-fitting shape keep it sleek under any collar — elegant even when it's cold.",
    images: [
  ...
  { id: 13, name: "Brunchelo", category: "Shoes", price: 15000, tag: null, stock: 8,
    description: "A contemporary silhouette crafted for all-day comfort without compromising style. Lightweight construction and a refined profile make it a natural companion from morning to evening.",
    images: [
  ...
  { id: 14, name: "Loro Piana Summer Walk", category: "Shoes", price: 15000, tag: null, stock: 7,
    description: "Inspired by the iconic Loro Piana tradition of luxury comfort, this sneaker pairs sumptuous materials with an understated silhouette — the very definition of quiet luxury done right.",
    images: [
  ...
  { id: 15, name: "Cashmere Crewneck Sweater", category: "Clothing", price: 78000, tag: "New", stock: 16,
    description: "Woven from Grade-A cashmere for exceptional softness and lasting warmth. The classic crewneck silhouette and ribbed trim make it a perennial staple across seasons and occasions.",
    images: [
  ...
  { id: 16, name: "Pleated Chino Trousers", category: "Clothing", price: 41000, tag: null, stock: 19,
    description: "A softer alternative to formal tailoring. Front pleats offer room to move while a clean line from hip to ankle maintains a polished, put-together appearance all day long.",
    images: [
  ...
  { id: 17, name: "Suede Loafers", category: "Shoes", price: 72000, tag: "Trending", stock: 11,
    description: "Slip-on ease meets Goodyear-welt construction. The nubuck suede upper molds gently to the foot over time, developing a character and fit that is entirely your own.",
    images: [
  ...
  { id: 18, name: "Leather Tote Bag", category: "Accessories", price: 55000, tag: "New", stock: 9,
    description: "Structured in vegetable-tanned leather that softens and patinas beautifully with age. A spacious interior holds daily essentials with room to spare; twin handles allow shoulder or hand carry.",
    images: [
  ...
  { id: 19, name: "Polo Shirt", category: "Clothing", price: 32000, tag: null, stock: 28,
    description: "The quintessential refined casual — a rib-knit collar, a two-button placket, and short sleeves cut to sit cleanly on the shoulder. Comfortable enough for leisure, sharp enough for smart-casual settings.",
    images: [
  ...
  { id: 20, name: "Running Sneakers", category: "Shoes", price: 65000, tag: "Trending", stock: 17,
    description: "Engineered for performance with a cushioned midsole and a breathable mesh upper. Reflective accents and a flexible outsole make them equally at home on the track or the street.",
    images: [
      "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600&q=80&auto=format&fit=crop",
  ...
  { id: 21, name: "Silk Pocket Square", category: "Accessories", price: 12000, tag: null, stock: 50,
    description: "Cut from 100% silk and hand-rolled at the edges. A single square introduces texture and colour to any breast pocket without overpowering the suit it accompanies.",
    images: [
